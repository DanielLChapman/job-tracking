...
var _JOBSApp = __webpack_require__(97);

var _JOBSApp2 = _interopRequireDefault(_JOBSApp);

var _jobs = __webpack_require__(116);
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  { store: createStoreWithMiddleware(_jobs2.default) },
  _react2.default.createElement(_JOBSApp2.default, null)
...
*/
var aa=__webpack_require__(2),ba=__webpack_require__(4),m=__webpack_require__(14),p=__webpack_require__(15),v=__webpack_require__(3),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ha=__webpack_require__(5);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11), __webpack_require__(73)(module)))
...
var _lodashIsplainobject = __webpack_require__(93);
...
var JOBSApp = function (_Component) {
	_inherits(JOBSApp, _Component);

	function JOBSApp(props) {
		_classCallCheck(this, JOBSApp);

		var _this = _possibleConstructorReturn(this, (JOBSApp.__proto__ || Object.getPrototypeOf(JOBSApp)).call(this, props));
...
function mapDispatchToProps(dispatch) {
	return (0, _redux.bindActionCreators)({ helloworld: _index.helloworld }, dispatch);
}

exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(JOBSApp);
...
var _reducer_job = __webpack_require__(117);

var _reducer_job2 = _interopRequireDefault(_reducer_job);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var jobReducer = (0, _redux.combineReducers)({
	jobs: _reducer_job2.default
});
...
exports.default = function () {
	...
	switch (action.type) {
		case _index.GRAB_API_KEYS:
			return action.payload.data.apiKeys || state;
		case _index.GENERATE_API_KEY:
			if (action.payload.data.apiKey) {
				return [].concat(_toConsumableArray(state), [action.payload.data.apiKey]);
			} else {
				alert(action.payload.data);
				return state;
			}

		case _index.DELETE_API_KEY:
